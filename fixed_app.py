...
# Routeهای اصلی با تمام endpointهای مورد نیاز templateها
@app.route('/')
@app.route('/home')
@app.route('/index')
def index():
...
@app.route('/nataq')
@app.route('/nataq_page')  # اضافه کردن endpoint مورد نیاز template
def nataq():
    return render_template('nataq.html')

@app.route('/mizanro')
@app.route('/mizanro_page')  # اضافه کردن endpoint مورد نیاز template
def mizanro():
    return render_template('mizanro.html')

@app.route('/anti_fragmentation')
@app.route('/anti_fragmentation_page')  # اضافه کردن endpoint مورد نیاز template
